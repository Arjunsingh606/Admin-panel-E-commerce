...
const Register: React.FC = () => {
  ...
  const handleSubmitForm = async (
    ...
    try {
      const data = await fetch("http://localhost:4000/admin", {
        method: "POST",
        headers: {
        ...
        <Col className="col-md-6 form-size">
          <div className="main-form">
            ...
            {admin && admin.length === 0 ? (
              ...
              <div className="admin-exist-msg"><p>The Admin is already exist ! multiple admin does not allowed. Please<Link to="/"> Login</Link> </p> 
              </div>
            )}
          </div>
        </Col>
